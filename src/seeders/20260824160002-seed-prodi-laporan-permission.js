...
const MENU_CODES = [
  'PRODI_LAPORAN_GROUP_MANAGEMENT',
  'PRODI_LAPORAN_IJAZAH_TRANSKRIP_MANAGEMENT',
  'PRODI_LAPORAN_CETAK_SURAT_MANAGEMENT',
  'PRODI_LAPORAN_CETAK_REALISASI_MANAGEMENT',
  'PRODI_LAPORAN_CETAK_MAHASISWA_PERKELAS_MANAGEMENT',
  'PRODI_LAPORAN_CETAK_KEHADIRAN_MENGAJAR_MANAGEMENT',
  'PRODI_LAPORAN_CETAK_KHS_MANAGEMENT',
];
