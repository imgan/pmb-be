...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('pembimbing_magang', {
    ...
    await queryInterface.addIndex('pembimbing_magang', ['dosen_id']);
  },

  down: async (queryInterface) => {
    await queryInterface.dropTable('pembimbing_magang');
  },
};
