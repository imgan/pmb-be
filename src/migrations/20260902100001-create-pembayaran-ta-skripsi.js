...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('pembayaran_ta_skripsi', {
    ...
    await queryInterface.addIndex('pembayaran_ta_skripsi', ['mahasiswa_id']);
  },
  down: async (queryInterface) => {
    await queryInterface.dropTable('pembayaran_ta_skripsi');
  },
};
